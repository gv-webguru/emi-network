...
<html <?php language_attributes(); ?>>
    <head>
		...
		<!-- So, this is the stupid header getting loaded? -->
...
<div class="close_video"><img src="<?php echourl(); ?>/images/x_video.png"></div>
<iframe id="player1" src="https://player.vimeo.com/video/138343846?title=0&byline=0&portrait=0" width="700" height="393" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
</div>
...
<!-- Header -->
  <header class="header">
    <div class="header-nav"> 
      ...
      <!-- <div id="search-icon">
      <i class=""></i>
        <form role="search" method="get" id="searchform" action="http://staging.eminetwork.com/nssa" class="">
      ...
      <nav role="navigation" class="navbar navbar-default solid-color white">
        <div class="container">
          <div class="navbar-header">
            ...
            <!-- logo --> 
            <a href="<?php echo echositeurl(); ?>" class="navbar-brand"> <img class="img-responsive" src="wp-content/themes/EMI Network/images/emi-logo.png" style="width:90%" alt=""></a></div>
...
<!--<li class="mobile bar_clearing"><a  href="<?php echo get_permalink( 3019 ); ?>">Our Team</a></li>--><!-- If I read this correctly, this should be commented out. -->
              <!--<li class="mobile bar_clearing"><a href="<?php echo get_permalink( 3015 ); ?>">Our Work</a></li>-->
        </ul>
...
<li class="mobile"><a  href="http://www.eminetwork.com/join-the-network/">Join Us</a></li>
          ...
          <li class="mobile bar_clearing search" id="search"><img src="wp-content/themes/EMI Network/images/searchicon.png" alt="Search"></li>
...
<div class="col-sm-3 col-md-3 pull-right">
  <div id="search-icon">
	...
	<h1>This is the heeder file we are using!</h1>
